...
<template>
  ...
  <div class="container">
    <h1 class="typing-demo">things to do</h1>
<div class="input-container">
  <input v-model="newToDoText" type="text" class="input" placeholder="What would you like to do today?">
...
.card{
  ...
  border-radius: 10px;
  box-shadow: 4px 4px 12px rgba(0, 0, 0, 0.308);
...
body {
  ...
  overflow: hidden; /* Hide any content overflowing from the body */
}
